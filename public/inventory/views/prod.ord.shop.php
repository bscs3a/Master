...
<body>
    ...
    <div class="flex place-content-end mt-10 mr-2">
        <button  class="items-end rounded-lg w- px-2 py-1 border border-black bg-yellow text-black duration-300">
        Back </button>
    </div>
    <div class="flex place-content-end mt-10">
        <button onclick="location.href='/Master/inv/Product_Order_Orders'" class="items-end rounded-lg w- px-2 py-1 border border-black bg-white text-black duration-300">
        Check Out </button>
    </div>
