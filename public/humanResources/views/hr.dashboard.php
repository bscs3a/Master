  ...
  <main class="w-[calc(100%-256px)] ml-64 bg-gray-50 min-h-screen">
    <div class="py-2 px-6 bg-white flex items-center shadow-md shadow-black/10">
      ...
      <ul class="ml-auto flex items-center">
        ...
        <li class="mr-1">
          <button type="button" class="w-8 h-8 rounded justify-center hover:bg-gray-300"><i
    ...
    <div class="ml-6 flex flex-col mt-8 mr-6">
      <div
        class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-300 shadow-md sm:rounded-lg">
                ...
                <div class="flex items-center">
                  <div class="flex-shrink-0 w-10 h-10">
                    <img class="w-10 h-10 rounded-full object-cover object-center"
                      src="https://pbs.twimg.com/profile_images/1679743561200463872/2XNOMV6V_400x400.jpg" alt="">
                  </div>
                  <div class="ml-4">
            ...
            <tr>
              <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                <div class="flex items-center">
                  <div class="flex-shrink-0 w-10 h-10">
                    <img class="w-10 h-10 rounded-full object-cover object-center"
                      src="https://pbs.twimg.com/profile_images/1649848448689086464/rkJG00b4_400x400.jpg" alt="">
                  </div>
                  <div class="ml-4">
